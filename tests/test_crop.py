...
from mmedit.datasets.pipelines import (Crop, RandomResizedCrop, CropAroundCenter, CropAroundFg,
...
class TestAugmentations:
    ...
    def test_random_resized_crop(self):
        ...
        with pytest.raises(TypeError):
            RandomResizedCrop(['img'], crop_size=(128, 128), scale=(0.5, 0.5), ratio=0.75)
        ...
        # test center crop
        results = copy.deepcopy(self.results)
        center_crop = RandomResizedCrop(['img'], crop_size=(128, 128), scale=(1.5, 2.0))
        results = center_crop(results)
